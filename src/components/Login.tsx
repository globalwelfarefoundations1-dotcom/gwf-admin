      ...
      <div className="relative hidden w-full flex-col justify-between overflow-hidden bg-stone-900 p-10 text-stone-50 lg:flex lg:w-1/2 xl:p-16">
        ...
        <div className="relative max-w-md text-center  m-[auto]">
          ...
          <p className="mt-4 text-stone-400">
            Manage your foundation's programmes, partnerships and impact from a single, elegant workspace.
          </p>
        </div>

        <div className="relative grid grid-cols-3 gap-6 border-t border-stone-700 pt-8">
          <div className="flex flex-col">
            <strong className="text-2xl font-semibold text-[#d9aa3f]">120+</strong>
            <span className="text-xs text-stone-400">Projects delivered</span>
          </div>
          <div className="flex flex-col">
            <strong className="text-2xl font-semibold text-[#d9aa3f]">28</strong>
            <span className="text-xs text-stone-400">Active programmes</span>
          </div>
          <div className="flex flex-col">
            <strong className="text-2xl font-semibold text-[#d9aa3f]">14</strong>
            <span className="text-xs text-stone-400">Communities served</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full flex-1 items-center justify-center bg-stone-50 px-4 py-10 sm:px-8 lg:w-1/2">
        <div className="w-full max-w-sm rounded-2xl border border-stone-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-stone-600">
                ...
                <span className="flex items-center gap-1">
                  <ShieldCheck size={15} /> Remember me
                </span>
              </label>
              <button type="button" className="font-medium text-[#b98a2c] hover:underline">
                Forgot password?
              </button>
            </div>

            {authError && (
              <div className="rounded-lg bg-red-50 px-3 py-2 text-sm text-red-600">{authError}</div>
            )}
          ...
          <div className="mt-6 flex items-center justify-center gap-1.5 text-xs text-stone-400 lg:justify-start">
            <ShieldCheck size={15} /> Protected by GWF security · Two-factor ready
          </div>
        </div>
      </div>
    </div>
